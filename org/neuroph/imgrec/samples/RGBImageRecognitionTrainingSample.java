...
public class RGBImageRecognitionTrainingSample {
    ...
    public static void main(String[] args) throws IOException {
        ...
        hiddenLayers.add(50);
        hiddenLayers.add(30);
        NeuralNetwork nnet = ImageRecognitionHelper.createNewNeuralNetwork("someNetworkName", new Dimension(20,20), ColorMode.BLACK_AND_WHITE, imageLabels, hiddenLayers, TransferFunctionType.SIGMOID);
